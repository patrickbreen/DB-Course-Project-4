...
public class TestTupleGeneratorAfterOptim {
	/***************************************************************************
	...
	public static void main(String[] args) throws SQLException, ClassNotFoundException, IOException {
		...
		runner.runScript(new BufferedReader(new FileReader("mysql_schema_after_optimization.sql")));
		...
		suc = stmt.execute(query) ;
		query = "TRUNCATE professor;" ;
		suc = stmt.execute(query) ;
		query = "TRUNCATE teaching;" ;
		suc = stmt.execute(query) ;
		query = "TRUNCATE transcript;" ;
		suc = stmt.execute(query) ;
